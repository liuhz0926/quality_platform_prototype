...
* In view.py load_evaluate, the home_address now is set to '~/quality_platform_prototype', i.e. the app is in the user folder in MacOS. This needs to be reset if the app is upload to the cloud or change to other location. 
